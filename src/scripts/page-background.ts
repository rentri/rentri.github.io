...
const devanagariText = 'अआइईउऊऋऌएऐओऔकखगघङचछजझञटठडढणतथदधनपफबभमयरलवशषसह';

/**
 * PageBackground class
 */
class PageBackground {
  private LETTER_FADE_DURATION: [number, number] = [1.5, 5]; // Seconds
  ...
  private initBackground = () => {
    ...
    let text: string = devanagariText;
    ...
    this.baseCtx.fillStyle = 'rgba(158, 151, 125, 0.03)';
